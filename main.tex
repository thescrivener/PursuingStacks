...
\stockletter
\pageletter
\settypeblocksize{44\baselineskip}{24.5pc}{*}
\setlrmargins{1in}{*}{*}
\setulmargins{1in}{*}{*}
...
\def\@hangsection[#1]#2{%
  ...
  \checkoddpage%
  \marginpar{{\ifoddpage\relax\else{$\phantom{1}$\\}\fi}\itshape #2}%
  \ignorespaces%
}
\makeatother
...
% \setsecnumformat{\llap{\@nameuse{the#1}\ }}
% \newcommand{\hangsection}[2][]{%
%   \setcounter{footnote}{0}%
%   \savebox{\@tempboxa}{\normalfont\bfseries\ }%
%   \section[#2][]{#1}\hspace*{-\wd\@tempboxa}%\hspace*{-.75em}
%   \checkoddpage%
%   \marginpar{{\ifoddpage\relax\else{$\phantom{1}$\\}\fi}\itshape #2}%
% }
% \setaftersecskip{0pt}
...
\newcommand{\namedpspage}[2]{%
  \phantomlabel{p:#1}{#2}%
  \checkoddpage%
  \marginpar{{\ifoddpage\relax\else{$\phantom{1}$\hfill}\fi}[p.\ #2]}}
\newcommand{\pspage}[1]{\namedpspage{#1}{#1}}
